...
/**
 * Class RewardingSegmentedActionResponse
 *
 * @author Abdullah Al-Faqeir
 * @package Devloops_Epoints
 */
class RewardingSegmentedActionResponse extends BaseResponse {
	 ...
	 */
	public function __construct( $Result, $ErrorDesc, $RequireReloadSettings, $Date, $Time, $TransactionID, $CardholderName, $AvailablePointsBalance, $CashEquivalent, $Amount, $PointsEarned, $LastTransactionID, $TotalAmount, $DiscountedAmount ) {
	...
	public static function parse( $xml ) {
		...
		return new self( $Result, $ErrorDesc, $RequireReloadSettings, $Date, $Time, $TransactionID, $CardholderName, $AvailablePointsBalance, $CashEquivalent, $Amount, $PointsEarned, $LastTransactionID, $TotalAmount, $DiscountedAmount );
	}
